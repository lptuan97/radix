...
function sendMail($to, $subject, $content)
{
    ...
    try {
        ...
        $mail->Username   = 'lephamtuan08@gmail.com';                     //SMTP username
        $mail->Password   = 'yrcc lfjy spuv llns';                               //SMTP password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
        $mail->Port       = 465;                                    //TCP

        //Recipients
        $mail->setFrom('lephamtuan08@gmail.com', 'Unicode Training');
...
/* isLogin();
    1.Kiểm tra $_SESSION['loginToken'] tồn tại trong database
        - Tồn tại: Đã đăng nhập
        - Không tồn tại: Chưa đăng nhập & xóa $_SESSION['loginToken']
    */
function isLogin()
{
    $checkLogin = false;
