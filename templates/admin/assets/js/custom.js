...
var button1 = document.getElementById('choose-image-add');
console.log(button1);
...
var classTextarea = document.querySelector('.editor');
...
//                     finder.on('files:choose', function (evt) {
//                         var file = evt.data.files.first();
//                         var output = parentElementObject.querySelector('.image-render').value = fileUrl;
//                         output.value = file.getUrl();
//                     });
