...
<head>
	...
	<!-- Favicon -->
	<link rel="icon" type="image/png" href=<?php linkTemplates("images/favicon.png") ?>>

	<!-- Google Font -->
	<link href="https://fonts.googleapis.com/css?family=Open+Sans:400,400i,600,700,800" rel="stylesheet">

	<!-- Bootstrap Css -->
	<link rel="stylesheet" href=<?php linkTemplates("css/bootstrap.min.css") ?>>
	<!-- Font Awesome CSS -->
	<link rel="stylesheet" href=<?php linkTemplates("css/font-awesome.min.css") ?>>
	<!-- Slick Nav CSS -->
	<link rel="stylesheet" href=<?php linkTemplates("css/slicknav.min.css") ?>>
	<!-- Cube Portfolio CSS -->
	<link rel="stylesheet" href=<?php linkTemplates("css/cubeportfolio.min.css") ?>>
	<!-- Magnific Popup CSS -->
	<link rel="stylesheet" href=<?php linkTemplates("css/magnific-popup.min.css") ?>>
	<!-- Fancy Box CSS -->
	<link rel="stylesheet" href=<?php linkTemplates("css/jquery.fancybox.min.css") ?>>
	<!-- Nice Select CSS -->
	<link rel="stylesheet" href=<?php linkTemplates("css/niceselect.css") ?>>
	<!-- Owl Carousel CSS -->
	<link rel="stylesheet" href=<?php linkTemplates("css/owl.theme.default.css") ?>>
	<link rel="stylesheet" href=<?php linkTemplates("css/owl.carousel.min.css") ?>>
	<!-- Slick Slider CSS -->
	<link rel="stylesheet" href=<?php linkTemplates("css/slickslider.min.css") ?>>
	<!-- Animate CSS -->
	<link rel="stylesheet" href=<?php linkTemplates("css/animate.min.css") ?>>

	<!-- Radix StyleShet CSS -->
	<link rel="stylesheet" href=<?php linkTemplates("css/reset.css") ?>>
	<link rel="stylesheet" href=<?php linkTemplates("style.css") ?>>
	<link rel="stylesheet" href=<?php linkTemplates("css/responsive.css") ?>>

	<!-- Radix Color CSS -->
	<link rel="stylesheet" href=<?php linkTemplates("css/color/color1.css") ?>>
				...
				<div class="row">
					<div class="col-lg-6 col-12">
						...
						<ul class="contact">
							...
							<li><i class="fa fa-clock-o"></i>Thời gian làm việc: <?php echo getOption('general_time'); ?></li>
						</ul>
						<!--/ End Contact -->
					</div>
					<div class="col-lg-6 col-12">
