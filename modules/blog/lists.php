...
//Truy vấn blog
$listBlog = getRaw("SELECT title, description, blog.id, thumbnail, view_count, blog.create_at, blog_categories.name as cate_name FROM blog INNER JOIN blog_categories ON blog.category_id=blog_categories.id ORDER BY blog.create_at DESC LIMIT $offset, $perPage");
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    for ($index = $begin; $index<=$end; $index++){
                        ...
                        echo '<li class="'.$classActive.'"><a href="'._WEB_HOST_ROOT.'?module=blog&page='.$index.'">'.$index.'</a></li>';
                    }
                            if ($page<$maxPage){
                                $nextPage = $page+1;
